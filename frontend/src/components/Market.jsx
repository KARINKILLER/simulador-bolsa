...
const Market = () => {
  ...
  const pedirDatos = async (ticker, codigoTiempo) => {
    ...
    try {
      const response = await fetch(`https://shivering-adriena-backendtfg-b6859741.koyeb.app/consult?activo=${ticker}&periodo=${codigoTiempo}`);
  ...
  const preCompra = async () => {
    const response = await fetch(`https://shivering-adriena-backendtfg-b6859741.koyeb.app/datos-pre-transaccion-compra?activo=${tickerSeleccionado}`, {credentials: 'include'});    
    if (!response.ok) throw new Error(`Error: ${response.status}`);
  ...
  const confirmarCompra = async () => {
    ...
    try {
        const response = await fetch('https://shivering-adriena-backendtfg-b6859741.koyeb.app/comprar-acciones', {
  ...
  const preVenta = async () => {
    ...
    const response = await fetch(`https://shivering-adriena-backendtfg-b6859741.koyeb.app/datos-pre-transaccion-venta?activo=${tickerSeleccionado}`, {credentials: 'include'});
    if (!response.ok) throw new Error(`Error: ${response.status}`);
  ...
  const confirmarVenta = async () => {
    ...
    const response = await fetch(`https://shivering-adriena-backendtfg-b6859741.koyeb.app/vender-acciones?activo=${tickerSeleccionado}&cantidad=${cantidadVendida}`, {credentials: 'include', method: 'POST'});
    if (!response.ok) throw new Error(`Error: ${response.status}`);
    cerrarModalVenta();
